...
TEST(COMPTransformTest, DefaultConstruction) {
    COMPTransform t;
    EXPECT_FLOAT_EQ(t.LocalPosition.x, 0.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.y, 0.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.z, 0.f);

    EXPECT_FLOAT_EQ(t.LocalScale.x, 1.f);
    EXPECT_FLOAT_EQ(t.LocalScale.y, 1.f);
    EXPECT_FLOAT_EQ(t.LocalScale.z, 1.f);

    EXPECT_FLOAT_EQ(t.LocalRotation.x, 0.f);
    EXPECT_FLOAT_EQ(t.LocalRotation.y, 0.f);
    EXPECT_FLOAT_EQ(t.LocalRotation.z, 0.f);
...
TEST(COMPTransformTest, MoveAddsToPosition) {
    ...
    EXPECT_FLOAT_EQ(t.LocalPosition.x, 1.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.y, 2.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.z, 3.f);
}
...
TEST(COMPTransformTest, MoveCumulative) {
    ...
    t.Move(glm::vec3(1.f, 0.f, 0.f));
    EXPECT_FLOAT_EQ(t.LocalPosition.x, 2.f);
}

TEST(COMPTransformTest, MoveNegativeDirection) {
    COMPTransform t;
    t.Move(glm::vec3(-5.f, -3.f, -1.f));
    EXPECT_FLOAT_EQ(t.LocalPosition.x, -5.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.y, -3.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.z, -1.f);
}
...
TEST(COMPTransformTest, SetPositionAbsolute) {
    ...
    EXPECT_FLOAT_EQ(t.LocalPosition.x, 3.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.y, 4.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.z, 5.f);
}
...
TEST(COMPTransformTest, SetPositionNegative) {
    ...
    EXPECT_FLOAT_EQ(t.LocalPosition.x, -2.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.y, -4.f);
    EXPECT_FLOAT_EQ(t.LocalPosition.z, -6.f);
}
...
TEST(COMPTransformTest, RotateAddsAngles) {
    ...
    EXPECT_FLOAT_EQ(t.LocalRotation.x, 90.f);
    EXPECT_FLOAT_EQ(t.LocalRotation.y, 45.f);
    EXPECT_FLOAT_EQ(t.LocalRotation.z, 30.f);
}
...
TEST(COMPTransformTest, RotateWrapsAt360) {
    ...
    EXPECT_NEAR(t.LocalRotation.x, 10.f, 0.001f);
}

TEST(COMPTransformTest, RotateExactly360WrapsToZero) {
    COMPTransform t;
    t.Rotate(glm::vec3(360.f, 0.f, 0.f));
    EXPECT_NEAR(t.LocalRotation.x, 0.f, 0.001f);
}
...
TEST(COMPTransformTest, RotateCumulative) {
    ...
    t.Rotate(glm::vec3(100.f, 0.f, 0.f));
    EXPECT_NEAR(t.LocalRotation.x, 200.f, 0.001f);
}
...
TEST(COMPTransformTest, SetRotationAbsolute) {
    ...
    EXPECT_NEAR(t.LocalRotation.x, 45.f, 0.001f);
    EXPECT_NEAR(t.LocalRotation.y, 90.f, 0.001f);
    EXPECT_NEAR(t.LocalRotation.z, 180.f, 0.001f);
}
...
TEST(COMPTransformTest, SetRotationWrapsAt360) {
    ...
    // 400 mod 360 = 40
    EXPECT_NEAR(t.LocalRotation.x, 40.f, 0.001f);
}
...
TEST(COMPTransformTest, ScaleCumulativeMultiplies) {
    ...
    // 2 * 3 = 6
    EXPECT_FLOAT_EQ(t.LocalScale.x, 6.f);
    EXPECT_FLOAT_EQ(t.LocalScale.y, 6.f);
    EXPECT_FLOAT_EQ(t.LocalScale.z, 6.f);
}

TEST(COMPTransformTest, ScaleByZeroCollapsesScale) {
    COMPTransform t;
    t.Scale(glm::vec3(0.f, 0.f, 0.f));
    EXPECT_FLOAT_EQ(t.LocalScale.x, 0.f);
    EXPECT_FLOAT_EQ(t.LocalScale.y, 0.f);
    EXPECT_FLOAT_EQ(t.LocalScale.z, 0.f);
}
...
TEST(COMPTransformTest, RotateNegativeAnglesStayInPositiveRange) {
    ...
    EXPECT_GE(t.LocalRotation.x, 0.f);
    EXPECT_LT(t.LocalRotation.x, 360.f);
}
